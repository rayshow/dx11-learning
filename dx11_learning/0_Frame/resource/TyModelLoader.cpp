...
bool TyModelReader::LoadPrimitivesFile(
	SModelData& data,
...
bool TyModelReader::ReadVerticesData(
	PrimitiveData& data,
	sec_info_t& sec,
	FILE *fp)
{
...
bool TyModelReader::ReadIndicesData(
	SModelData& data,
	sec_info_t& sec,
	FILE *fp)
{
...
bool TyModelReader::LoadMaterialFile(
